...
train_dir = os.path.join(os.getcwd(), "../../data/happiness/train")
validation_dir = os.path.join(os.getcwd(), "../../data/happiness/validation")
...
num_happiness_tr = len(os.listdir(train_happiness_dir))
num_other_tr = len(os.listdir(train_other_dir))

num_happiness_val = len(os.listdir(validation_happiness_dir))
num_other_val = len(os.listdir(validation_other_dir))

total_train = num_happiness_tr + num_other_tr
total_val = num_happiness_val + num_other_val

print('total training happiness images:', num_happiness_tr)
print('total training other images:', num_other_tr)

print('total validation happiness images:', num_happiness_val)
